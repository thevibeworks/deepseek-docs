...
| 思考模式 | | | 支持非思考与思考模式（默认） 切换方式详见[思考模式](../guides/thinking_mode.md) | |
| 上下文长度 | | | 1M | |
| 输出长度 | | | 最大 384K | |
| 功能 | [Json Output](../guides/json_mode.md) | | 支持 | 支持 |
| [Tool Calls](../guides/tool_calls.md) | | 支持 | 支持 |
| [Responses API](../guides/responses_api.md) | | 支持 | 支持 |
| [Anthropic API](../guides/anthropic_api.md) | | 支持 | 支持 |
| [对话前缀续写（Beta）](../guides/chat_prefix_completion.md) | | 支持 | 支持 |
| [FIM 补全（Beta）](../guides/fim_completion.md) | | 仅非思考模式支持 | 仅非思考模式支持 |
| [图像理解](../guides/vision.md) | | 支持 | 不支持 |
...
(3) 更多并发限制细节，请参考[限速与隔离](rate_limit.md)。
