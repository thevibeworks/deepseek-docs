...
description: "今天，我们正式发布 DeepSeek V4.1 Flash 模型。这是我们全新模型结构系列中的最小尺寸的模型，具备原生多模态视觉理解能力。新模型结构的设计初衷是：能力上限更高、推理速度更快、吞吐更大、可扩展到更大参数模型。"
...
![](https://api-docs.deepseek.com/zh-cn/img/v4.1_260910_benchmark.png)

DeepSeek-V4.1-Flash 与主流前沿模型在 Agentic Benchmark 上的性能对比

![](https://api-docs.deepseek.com/zh-cn/img/v4.1_260910_benchmarktable_cn.png)
...
![](https://api-docs.deepseek.com/zh-cn/img/v4.1_260910_kvcache.png)
...
![](https://api-docs.deepseek.com/zh-cn/img/v4.1_260910_price_cn.jpeg)
