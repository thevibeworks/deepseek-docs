...
source: https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/user/guide/providers.md
fetched: 2026-09-05
---
# Configure models
...
![The Models page: the DeepSeek card, with Add provider and Add a custom provider below it](https://raw.githubusercontent.com/deepseek-ai/deepseek-harness/master/docs/user/guide/providers-models-page.png)
...
![The custom provider form: Provider ID, display name, base URL, API protocol, and API key](https://raw.githubusercontent.com/deepseek-ai/deepseek-harness/master/docs/user/guide/providers-custom-form.png)
