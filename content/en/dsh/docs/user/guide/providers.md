...
![The Models page: the DeepSeek card, with Add model provider below it](https://raw.githubusercontent.com/deepseek-ai/deepseek-harness/master/docs/user/guide/providers-models-page.png)
...
![The custom model API form: Provider ID, display name, base URL, API protocol, and API key](https://raw.githubusercontent.com/deepseek-ai/deepseek-harness/master/docs/user/guide/providers-custom-form.png)
